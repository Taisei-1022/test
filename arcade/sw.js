...
var CACHE = "vappa-0.9.29";
var CORE = [
  "./", "./index.html", "./play.html", "./leaderboard.html",
  "./manifest.webmanifest", "./logo.png?v=1",
  "./css/app.css?v=27",
  "./js/games.js?v=5", "./js/assets.js?v=1", "./js/config.js?v=4", "./js/store.js?v=5",
  "./js/ai.js?v=12", "./js/catalog.js?v=9", "./js/share.js?v=4", "./js/arcade-embed.js?v=3", "./js/pwa.js?v=1"
];
